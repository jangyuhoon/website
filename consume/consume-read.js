...
function generateNotification(selectorId, selectedPostId) {
    ...
    const notification = {
        ...
        message: `${selectorNickname}님이 회원님의 게시글 "${selectedPost.title}"을(를) 선택하였습니다.`, // Corrected escaping for double quotes within template literal
...
function updatePost(updatedPost) {
    ...
    if (index !== -1) {
        ...
        localStorage.setItem('consumePosts', JSON.stringify(posts));
